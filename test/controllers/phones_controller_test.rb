...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { kind: @phone.kind, user_profile_id: @phone.user_profile_id, value: @phone.value } }, as: :json
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { kind: @phone.kind, user_profile_id: @phone.user_profile_id, value: @phone.value } }, as: :json
    assert_response 200
  end
